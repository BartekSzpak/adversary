...
from app.engine.objects import Job, Host, Rat, Opcodes
from app import powershell
...
def clean_files(rat: Rat) -> Job:
    return powershell_function(rat, "footprint", PSFunction("File-Recover"))
